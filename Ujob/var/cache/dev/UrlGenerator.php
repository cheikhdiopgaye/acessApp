...
return [
    ...
    'inscriptionC' => [[], ['_controller' => 'App\\Controller\\CandidatController::inscriptionCandidat'], [], [['text', '/api/inscriptionC']], [], []],
    'update_candidat' => [['id'], ['_controller' => 'App\\Controller\\CandidatController::updateCandidat'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/candidat/update']], [], []],
    'bloquer_debloquer_candidat' => [['id'], ['_controller' => 'App\\Controller\\CandidatController::bloquerCandidat'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/candidat/bloquer']], [], []],
